...
const education = [
  {
    ...
    year: '2025 - 2026',
    description: 'Currently pursuing Bachelor of Science in Software Engineering',
    current: true,
  },
  {
    ...
    institution: 'ICBT Campus',
    year: '2023 - 2024',
    description: 'Completed higher diploma with focus on software development and engineering principles',
    current: false,
  },
  {
    degree: 'A/L Maths Stream',
    institution: 'J/ Nelliady Central College',
    year: 'Completed',
    description: 'Advanced Level education in Mathematics stream',
    current: false,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Get to know more about my background, skills, and journey as a software developer
          </p>
        </div>
        ...
        >
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">
              Software Engineering undergraduate with experience in PHP, Java, Python, SQL, HTML, CSS,
              JavaScript, and MySQL. Focused on backend development, databases, and building
              ...
              >
                ...
                >
                  <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300">
                    ...
                    <p className="text-slate-500 dark:text-slate-500 text-sm">{edu.description}</p>
                  </div>
                </div>
              </div>
            ))}
